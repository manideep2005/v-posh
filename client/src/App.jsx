...
import FacultyCaseDetail from './pages/faculty/FacultyCaseDetail';
      ...
      <AuthProvider>
        <Router>
          <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
            ...
            {/* Instant screen-hide for anyone on a shared or monitored device */}
            <PrivacyGuard />
            <SessionExpiryBanner />
            <Header />
            <main id="main-content" style={{ flex: '1 0 auto' }} tabIndex={-1}>
              <Routes>
                {/* Public Routes */}
                ...
                <Route path="/faculty/complaints/:id" element={<ProtectedRoute allowedRoles={['faculty']}><FacultyCaseDetail /></ProtectedRoute>} />
